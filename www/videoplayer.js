...
module.exports = {
    ...
    // setVideoPosition: function (x, y, width, height, successCallback, errorCallback) {
    //     exec(successCallback, errorCallback, "VideoPlayer", "setVideoPosition", [x, y, width, height]);
    // },
